...
const LastestUpdatesList = ({listTitle}) => {
  return (
    <View
        className="p-2"
    >
        <Text className="text-4xl text-grayDark font-semibold">{listTitle}</Text>
        <FlatList
            data={DATA}
            renderItem={({item}) => <LatestUpdateItem title={item.title} />}
...
export default LastestUpdatesList